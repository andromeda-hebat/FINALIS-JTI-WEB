        ...
        <div class="card shadow-sm" style="background-color: #F3F7FF;">
          <div class="card-body p-5">
            <div class="card-title mb-4 d-flex justify-content-start">
              <h4 class="fw-bold" style="color: #052C65;">Tambah Data Admin</h4>
            ...
            <form>
              ...
              <div class="form-group mt-3">
                <label for="tanggal" class="font-weight-bold">Tanggal Bergabung</label>
              ...
              <div class="d-flex justify-content-center mt-4">
                <button type="submit" class="text-white px-2" style="background-color: #052C65;">Tambahkan</button>
              </div>
            </form>
          </div>
        </div>
