...
<div class="d-flex flex-column align-items-center border-end justify-content-center position-fixed"
    ...
    <div class="d-flex text-center py-4 mb-4">
        ...
        <h3 class="d-flex align-items-center justify-content-center fw-bold text-center"
            style="color: var(--color-golden-yellow); font-weight: 800; line-height: normal !important;">FINALIS JTI
        </h3>
    </div>

    <nav class="nav w-100 d-flex flex-column text-start">
        <a href="/dashboard" class="sidebar-nav nav-link text-white w-100 ps-5 fw-bold">
            Dashboard
        </a>
        <div class="sidebar-nav nav-link text-white w-100 ps-5 fw-bold kelola-data">
            <div class="d-flex align-items-center">
                Kelola Data
                <svg width="20" height="20" class="ms-5" width="24" height="24" viewBox="0 0 24 24" fill="none"
    ...
    <div class="mt-auto w-100 mb-4 d-flex justify-content-center" style="">
        <button type="button" class="sidebar-nav nav-link w-100 ps-5 p-3 d-flex text-white text-start"
            data-bs-toggle="modal" data-bs-target="#modal-confirmation-logout">
